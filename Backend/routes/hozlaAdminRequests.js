...
router.route("/getAllBeatsTypes/:year").get((req, res) => {
  ...
  HozlaAdminRequest.find()
    .then((request) => {
      ...
      // console.log(color2A0, color2A3, color2A4, color2A5, color2A6, color2A4b, color2A3b);
      // console.log( color1A0,color1A3, color1A4,color1A5,color1A6,color1A4b, color1A3b);
    })
    .then(() =>
      res.json({
        bw2A0,
